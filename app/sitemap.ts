...
const STATIC_ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/access/koya-station", priority: 0.6, changeFrequency: "monthly" },
  { path: "/access/ogiohashi-station", priority: 0.6, changeFrequency: "monthly" },
  { path: "/cases", priority: 0.7, changeFrequency: "monthly" },
  { path: "/review", priority: 0.3, changeFrequency: "yearly" },
