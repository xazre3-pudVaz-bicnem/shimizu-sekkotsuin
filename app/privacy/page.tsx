...
const sections: { t: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "当サイトでは、ページの見やすさを改善する目的で、Google アナリティクス（Google LLC）および Microsoft Clarity（Microsoft Corporation）を利用しています。Microsoft Clarity では、どこがよく見られているか・どこでスクロールが止まるかといった画面上の操作を記録しますが、入力内容や文字は自動的に伏せられ、氏名・連絡先・症状などの個人を特定できる情報は取得しません。",
      "これらのツールによる情報収集を望まない場合は、ブラウザの設定でCookieを無効にするか、各社の提供する無効化手段をご利用ください。",
    ],
  },
  {
    t: "3. 利用目的",
